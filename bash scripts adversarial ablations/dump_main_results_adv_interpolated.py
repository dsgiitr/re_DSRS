...
new_radius_dir = 'data_interp/new-radius'
...
def dataset_level_print(ds_print_name, ds_internal_name, train_print_name, train_internal_name, k, N, Qsigmas,
    ...
    print(f'Smoothing distribution: generalized Gaussian with k = {k}, sigma = 0.05')
    sigma = 0.05
    model = f'{train_internal_name}-{ds_internal_name}-{1530}-{sigma}.pth'
    '''
    ...
    print(f'Smoothing distribution: generalized Gaussian with k = {k}, sigma = 0.1')
    sigma = 0.10
    model = f'{train_internal_name}-{ds_internal_name}-{1530}-0.10.pth'
    '''
    print('Neyman-Pearson certification')
    nice_print(read_original_radius(model, 'general-gaussian', k, sigma, N, 0.001), unit=0.25)
    '''
    ...
    print(f'Smoothing distribution: generalized Gaussian with k = {k}, sigma = 0.2')
    sigma = 0.20
    model = f'{train_internal_name}-{ds_internal_name}-{1530}-0.20.pth'
    '''
    print('Neyman-Pearson certification')
    nice_print(read_original_radius(model, 'general-gaussian', k, sigma, N, 0.001), unit=0.25)
    '''
...
if __name__ == '__main__':
    ...
    dataset_level_print('CIFAR10', 'cifar', 'Gaussian Augmentation', 'cohen', 1530, N, [0.025, 0.05, 0.1],
                        standard_stdout)

    print(""">>>>> Table 2 and Table 7 - CIFAR10 - Consistency """)
    dataset_level_print('CIFAR10', 'cifar', 'Consistency', 'consistency', 1530, N, [0.025, 0.05, 0.1],
                        standard_stdout)
    
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - SmoothMix """)
    dataset_level_print('CIFAR10', 'cifar', 'SmoothMix', 'smoothmix', 1530, N, [0.025, 0.05, 0.1],
                        standard_stdout)
    '''
