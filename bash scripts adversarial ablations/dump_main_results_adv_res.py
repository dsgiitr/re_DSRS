...
if __name__ == '__main__':
    ...
    for k in k_list:
        ...
        #dataset_level_print('CIFAR10', 'cifar10', 'SmoothMix', 'smoothmix', 1530, N, [0.2, 0.4, 0.8],
         #                   standard_stdout)
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - Gaussian Augmentation """)
    dataset_level_print('CIFAR10', 'cifar10', 'Gaussian Augmentation', 'gaussian', 1530, N, [0., 0.4, 0.8],standard_stdout)
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - Consistency """)
    dataset_level_print('CIFAR10', 'cifar10', 'Consistency', 'consistency', K, N, [0.2, 0.4, 0.8],standard_stdout)
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - SmoothMix """)
    dataset_level_print('CIFAR10', 'cifar10', 'SmoothMix', 'smoothmix', 1530, N, [0.2, 0.4, 0.8],standard_stdout)
    '''
