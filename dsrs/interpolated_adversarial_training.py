# code from https://github.com/ndb796/Pytorch-Adversarial-Training-CIFAR/blob/master/interpolated_adversarial_training.py
...
k = 7
alpha = 0.00784
file_name = 'interpolated_adversarial_training.pth'
mixup_alpha = 1.0
