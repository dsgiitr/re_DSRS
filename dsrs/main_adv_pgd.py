...
parser.add_argument('--sampling_dir', type=str, default='data_adv/sampling')
                    #description="folder for extracting the sampling pA info.")
parser.add_argument('--original_rad_dir', type=str, default='data_adv/orig-radius')
...
parser.add_argument('--new_rad_dir', type=str, default='data_adv/new-radius')
