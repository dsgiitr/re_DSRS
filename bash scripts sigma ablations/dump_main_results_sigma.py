# This can nly print mnist and cifar 10 results
import os
import sys
...
new_radius_dir = 'data_sigma/new-radius'
orig_radius_dir = 'data_sigma/orig-radius'

# place to store the output human-friendly or TeX-friendly tables and figures
result_folder = 'result_adv_sigma'
...
def dataset_level_print(ds_print_name, ds_internal_name, train_print_name, train_internal_name, k, N, Qsigmas,
    ...
    epoches=150
    if ds_internal_name == "mnist" and train_internal_name == "smoothmix":
        epoches = 90
    lr="001"
    if ds_internal_name == "cifar10" and train_internal_name == "smoothmix":
        lr = "01"
    ...
    print(f'Smoothing distribution: generalized Gaussian with k = {k}, sigma = 0.25 and N = {N/2}')
    
    
    sigma = 0.05
    model = f'{ds_internal_name}_quarter_{train_internal_name}_{epoches}_{lr}'
    '''
    ...
    model = f'{ds_internal_name}_half_{train_internal_name}_{epoches}_{lr}'
    sigma = 0.10
    '''
    print('Neyman-Pearson certification')
    nice_print(read_original_radius(model, 'general-gaussian', k, sigma, N, 0.001), unit=0.25)
    ...
    model = f'{ds_internal_name}_one_{train_internal_name}_{epoches}_{lr}'
    sigma = 0.20
...
if __name__ == '__main__':
    ...
    dataset_level_print('MNIST', 'mnist', 'Gaussian Augmentation', 'gaussian', 380, N, [0.2, 0.4, 0.8],
                        standard_stdout)
    ...
    dataset_level_print('MNIST', 'mnist', 'SmoothMix', 'smoothmix', 380, N, [0.2, 0.4, 0.8],
        ...
        '''
    '''
    k_list = [200,400,600,800,1000,1200,1400,1521,1525,1529,1533]
    for k in k_list:
        #print(""">>>>> Table 2 and Table 7 - CIFAR10 - Gaussian Augmentation """)
        #dataset_level_print('CIFAR10', 'cifar10', 'Gaussian Augmentation', 'gaussian', 1530, N, [0.2, 0.4, 0.8],
         #                   standard_stdout)

        print(""">>>>> Table 2 and Table 7 - CIFAR10 - Consistency """)
        dataset_level_print('CIFAR10', 'cifar10', 'Consistency', 'consistency', K, N, [0.2, 0.4, 0.8],
                            standard_stdout)

        #print(""">>>>> Table 2 and Table 7 - CIFAR10 - SmoothMix """)
        #dataset_level_print('CIFAR10', 'cifar10', 'SmoothMix', 'smoothmix', 1530, N, [0.2, 0.4, 0.8],
         #                   standard_stdout)
    '''
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - Gaussian Augmentation """)
    dataset_level_print('CIFAR10', 'cifar10', 'Gaussian Augmentation', 'gaussian', 1530, N, [0.025, 0.05, 0.1],standard_stdout)
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - Consistency """)
    dataset_level_print('CIFAR10', 'cifar10', 'Consistency', 'consistency', 1530, N, [0.025, 0.05, 0.1],standard_stdout)
    print(""">>>>> Table 2 and Table 7 - CIFAR10 - SmoothMix """)
    dataset_level_print('CIFAR10', 'cifar10', 'SmoothMix', 'smoothmix', 1530, N, [0.025, 0.05, 0.1],standard_stdout)
    '''
    print(""">>>>> Table 2 and Table 8 - ImageNet - Gaussian Augmentation """)
    dataset_level_print('ImageNet', 'imagenet', 'Gaussian Augmentation', 'gaussian', 75260, N, ['x+', 'x+', 'x+'],
                        standard_stdout)
